...
```bash
cargo install reinhardt-admin-cli --version "0.4.0-alpha.14"
```
...
reinhardt-admin startproject myproject --with-rest \
  --reinhardt-version 0.4.0-alpha.14 \
...
reinhardt-admin plugin install auth-delion --version 0.4.0-alpha.14
