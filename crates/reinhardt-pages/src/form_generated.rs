...
pub struct StaticFormMetadata {
	/// HTML id attribute for the form element (auto-generated from form name)
	pub id: String,
...
mod tests {
	...
	fn test_static_form_metadata_creation() {
		let form = StaticFormMetadata::new("login-form", "/api/login", "POST", "login-form");
	...
	fn test_static_metadata_serialization() {
		let form = StaticFormMetadata::new("test-form", "/api/test", "POST", "test-form")
