...
## [0.3.2](https://github.com/kent8192/reinhardt-web/compare/reinhardt-middleware@v0.3.1...reinhardt-middleware@v0.3.2) - 2026-07-14
...
- Replace `SessionStoreRef` injection with `Depends<SessionStore>`.
