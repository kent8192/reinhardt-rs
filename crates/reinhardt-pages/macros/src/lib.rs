...
//! `use_form`, whose runtime contract is generated by `form!`.
//!
...
/// - [Reactive Features](#reactive-features) - Field bindings, derived values, and watches
/// - [Customization](#customization) - Wrappers, icons, attributes, and slots
/// - [Advanced Features](#advanced-features) - Redirects and initial loading
///
/// # Overview
///
...
/// ## Runtime Behavior
///
/// `form!` runtime callback clauses (`on_submit`, `on_success`,
/// `on_success_ref`, `on_error`, and `on_loading`) were removed. Configure
/// runtime form behavior through `use_form(&form)` instead.
///
/// ## Redirect on Success
///
