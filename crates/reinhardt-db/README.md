...
```toml
[dependencies]
reinhardt-db = { version = "0.4.0-alpha.14", features = ["postgres", "orm", "migrations"] }
```
...
```toml
[dependencies]
reinhardt-db = { version = "0.4.0-alpha.14", features = ["pgvector"] }
...
```toml
[dependencies]
reinhardt = { package = "reinhardt-web", version = "0.4.0-alpha.14", features = ["db-pgvector"] }
```
